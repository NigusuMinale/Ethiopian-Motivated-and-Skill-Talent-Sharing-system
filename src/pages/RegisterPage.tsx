      ...
      <div className="relative z-10 max-w-md mx-auto w-full px-6 pt-12 pb-16">
        ...
        >
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h1 className="text-xl font-black text-foreground">Join EMSTS</h1>
          ...
          <div className="rounded-2xl border border-border/60 bg-card/80 overflow-hidden shadow-xl">
            ...
            <div className="p-8">
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] uppercase tracking-widest font-mono text-muted-foreground">Confirm Password</label>
                  <input
                    type="password"
                    value={confirm}
